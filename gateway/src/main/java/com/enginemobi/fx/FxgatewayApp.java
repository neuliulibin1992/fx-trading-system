...
@EnableZuulProxy
public class FxgatewayApp {

    private static final Logger log = LoggerFactory.getLogger(FxgatewayApp.class);

    private final Environment env;

    public FxgatewayApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes fxgateway.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(FxgatewayApp.class);
