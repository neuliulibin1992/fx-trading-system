...
```
$ docker image tag fxpriceservice pkcool/fxpriceservice
$ docker push pkcool/fxpriceservice
$ docker image tag fxgateway pkcool/fxgateway
$ docker push pkcool/fxgateway
```
...
$ kubectl apply -f fxpriceservice
$ kubectl apply -f fxgateway
```
